		...
		<div>
			<form id="form" class="form-inline"
				...
				<div class="form-group" style="margin:5px">
					...
					<select id="app_poi_code" class="select2" style="width:280px" class="form-control">
					</select>
				</div>
				<div class="form-group" style="margin:5px">
					<label for="jjy_diff_type" class="control-label">订单类型：</label>
					<select id="jjy_diff_type" class="select2"  style="width:150px" class="form-control">
						<option value="">全部</option>
						<option value="0">正常单</option>
						<option value="1" >补单</option>
						<option value="2">订单推送异常单</option>
						<option value="3" selected="selected" >补单+订单推送异常单</option>
					</select>
				</div>
				<div class="form-group" style="margin:5px">
				...
				<div class="form-group" style="margin:5px">
					<div style="float:right;margin-right: 20px;margin-top: 10px;margin-bottom: 10px;">
						...
						<button type="button" class="btn btn-primary btn-sm" onclick="tableExport()">导出</button>
					</div>
				</div>
			</form>
		</div>
...
<script type="text/javascript">
    ...
    var exportUrl = 'orderManage/completedOrder/export.do';
    ...
    function tableExport(){
        $('#form').attr("action", exportUrl).submit();
	}
</script>
