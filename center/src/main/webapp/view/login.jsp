...
<section>
    <div class="signinpanel" style="width:780px;">
        <div class="row">
            ...
            <div class="col-xs-5">
                <form method="post" action="<%=basePath %>login.do">
                    ...
                    <div class="remember" style="color:red;">${msg}</div>
                    <!-- 图形验证-->
                    <div class="form-group" >
                        <div class="row">
                            <div class="col-sm-8" >
                                <input type="text" id="code" name="code" class="form-control" placeholder="验证码" data-toggle="tooltip" data-placement="top">
                            </div>
                            <div class="col-sm-4"  style="margin-top:16px">
                                <img id="codeImg" src="<%=basePath %>captcha.do" onclick="this.src='<%=basePath %>/captcha.do?'+Math.random()" class="img-responsive" style="cursor:pointer;display: block;width:100%;height: 39px">
                            </div>
                        </div>
                    </div>
...
/*    $("#codeImg").click(function(){
        var src = "captcha.do"   //新图片地址
        $("#codeImg").attr("src",src);    //更换图片地址
    });*/
</script>