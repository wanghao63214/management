    ...
    <div class="panel panel-default">
        <div class="panel-body panel-body-nopadding ">
            <form id="addUserForm123" action='user/add.do' method="post"  onkeydown="if(event.keyCode==13){return false;}"
                ...
                <div class="form-group">
                    <label for="roleId" class="col-xs-2 control-label">角色： <span class="asterisk">*</span></label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <label for="app_poi_code" class="col-xs-2 control-label">门店：</label>
                    <div class="col-xs-4">
...
<script type="text/javascript">
    ...
    function submitForm() {
        //判断
        if( !$('#userName').val() || !$('#password').val() || !$('#salt').val() || !$('#roleId').val() ){
            alert("必填项不能为空!");
            return;
        }
