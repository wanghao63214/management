...
<script type="text/javascript">
            ...
            columns: [
                {
                    ...
                    field: 'is_online', title: '门店美团订单数据是否传回drp', sortable: false, align: 'center', formatter: isOnlineType
                }, {
                    ...
                    field: 'package_bag_skuid', title: '打包袋skuId', sortable: false, align: 'center'
                }, {
    ...
    function isOnlineType(value, row, index) {
        var map = new Map();
        map.set("1", "<span class='badge badge-success'>是</span>");
        map.set("2", "<span class ='badge badge-danger'>否</span>");
